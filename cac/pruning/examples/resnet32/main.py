...
def main():
    ...
    model_info['l30_conv1'] = {'arg': 'ch_l30conv1', 'prev': ['l20_bn2', 'l21_bn2', 'l22_bn2', 'l23_bn2', 'l24_bn2']}
    ...
    model_info['linear'] = {'arg': None, 'prev': ['l30_bn2', 'l31_bn2', 'l32_bn2', 'l33_bn2', 'l34_bn2']}
