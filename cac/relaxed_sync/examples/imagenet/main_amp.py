# main_amp.py COPYRIGHT Fujitsu Limited 2021
import argparse
import os
import shutil
import time
...
def parse():
    ...
    parser.add_argument('--num-sleep-procs', type=int, default=0)
...
def main():
    ...
    torch.manual_seed(args.local_rank)
    torch.set_printoptions(precision=10)
    torch.cuda.manual_seed(args.local_rank)
    ...
    if args.distributed:
        ...
        model = DDP(model, delay_allreduce=True, relaxed_sync_threshold=3.0, simulate_slow_process=0)
